...
index_files.md 内の変換前ファイル名リンクを新パスへ書き換える。
...
def restructure_files(docs_dir):
    ...
    # 変換前ファイル名 -> 変換後相対パス (Files/ 配下) の対応表
    rename_map = {}
