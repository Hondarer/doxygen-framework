...
- **Markdown 出力先**: `../docs-src/doxybook2/`
...
- **Markdown 出力先**: `../docs-src/doxybook2/api/`
...
このコマンドは `docs/doxygen/api/`、`docs-src/doxybook2/api/`、`xml/api/` を削除します。
